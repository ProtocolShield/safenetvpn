...
abstract class FlutterVpnPlatform extends PlatformInterface {
  ...
  Future<bool> setKillSwitch(bool enabled) {
    throw UnimplementedError('setKillSwitch() has not been implemented.');
  }

  /// Check if the kill switch is enabled.
  Future<bool> get killSwitchEnabled {
    throw UnimplementedError('killSwitchEnabled has not been implemented.');
  }
}
