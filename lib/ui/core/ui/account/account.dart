...
class Account extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var provider1 = Get.put<HomeGateModel>(HomeGateModel());
    return Scaffold(
      body: SafeArea(
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              provider1.proActive.value == true
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            DetailRow(
                              icon: Icons.calendar_today,
                              title:
                                  "${provider1.expiryAt.value.day} / ${provider1.expiryAt.value.month} / ${provider1.expiryAt.value.year}",
                              subtitle: 'Expires on',
                            ),
                            const Divider(
                              color: Color(0xFF353535),
                            ...
                            DetailRow(
                              ...
                              title:
                                  '${provider1.expiryAt.value.difference(DateTime.now()).inDays} days remaining',
                  ...
                  : Column(
                      children: [
                        SizedBox(height: 20),
                        Center(
                          child: Text("No Subscription Details Available"),
                        ),
                      ],
                    ),
            ],
