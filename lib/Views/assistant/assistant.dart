...
class QuickActionsRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Row(
        children: const [
          QuickChip(icon: EvaIcons.shield, label: 'Privacy Scan'),
          SizedBox(width: 12),
          QuickChip(icon: EvaIcons.globe, label: 'Best Server'),
          SizedBox(width: 12),
          QuickChip(icon: EvaIcons.barChart2, label: 'Usage Stats'),
        ],
      ),
    );
  }
...
class QuickChip extends StatelessWidget {
  const QuickChip({super.key, required this.icon, required this.label});
  final IconData icon;
  final String label;
  @override
  Widget build(BuildContext context) {
