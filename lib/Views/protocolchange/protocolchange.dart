                  ...
                  child: Row(
                    children: [
                      ...
                      Switch(
                        ...
                        onChanged: (val) async {
                          if (homeRepo.vpnConnectionState.value == VpnConnectedStates.connected ||
                              homeRepo.vpnConnectionState.value == VpnConnectedStates.connecting) {
                            final shouldDisconnect = await showDisconnectDialog(context);
                            if (shouldDisconnect) {
                              if (homeRepo.selectedProtocol == Protocol.wireguard) {
                                await homeRepo.disconnectWireguard();
                              } else {
                                await homeRepo.disconnectIkeav2(context);
                              }
                            } else {
                              return;
                            }
                  ...
                  child: ListView(
                    ...
                    children: [
                      _buildProtocolOption(
                        ...
                        selected: homeRepo.selectedProtocol == Protocol.ikeav2 && !homeRepo.autoSelectProtocol,
                        onTap: () async {
                          if (!homeRepo.autoSelectProtocol) {
                            ...
                            await homeRepo.setProtocol(Protocol.ikeav2);
                          }
                        },
                      ),
                      const Divider(color: Color(0xFF232326), thickness: 1, height: 32),
                      _buildProtocolOption(
                        ...
                        title: 'Wireguard',
                        description: 'Disbale intenet access if VPN conection suddenly drops. You should active alwasy-on VPN firstly',
                        selected: homeRepo.selectedProtocol == Protocol.wireguard && !homeRepo.autoSelectProtocol,
                        onTap: () async {
                          if (!homeRepo.autoSelectProtocol) {
                            if (homeRepo.vpnConnectionState.value == VpnConnectedStates.connected ||
                                homeRepo.vpnConnectionState.value == VpnConnectedStates.connecting) {
                            ...
                            await homeRepo.setProtocol(Protocol.wireguard);
                          }
                        },
                      ),
                    ],
